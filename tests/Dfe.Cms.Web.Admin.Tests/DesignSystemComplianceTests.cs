...
/// </summary>
public class DesignSystemComplianceTests : IClassFixture<AdminWebApplicationFactory>
{
    private readonly HttpClient _client;

    public DesignSystemComplianceTests(AdminWebApplicationFactory factory)
    {
    ...
    public async Task HomePage_WhenRequested_TitleEndsWithServiceNameAndGovUk()
    {
        ...
        var title = titleMatch.Groups[1].Value;
        Assert.EndsWith("DfE CMS Admin - GOV.UK", title);
    }
}
